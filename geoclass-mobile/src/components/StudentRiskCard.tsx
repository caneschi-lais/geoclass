...
export default function StudentRiskCard({ item }: Props) {
  return (
    <View className="bg-white dark:bg-slate-800 rounded-xl p-4 mb-3 shadow-sm border-l-4 border-l-red-500 border border-y-gray-100 border-r-gray-100 flex-row justify-between items-center">
