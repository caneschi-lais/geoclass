...
export default function DashboardStatCard({ item }: Props) {
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default: return 'bg-gray-100 text-gray-800 dark:text-slate-100 border-gray-200 dark:border-slate-700';
    }
  };
  ...
  return (
    <View className="bg-white dark:bg-slate-800 rounded-xl p-5 mb-4 shadow-sm border border-gray-100 dark:border-slate-700 flex-row justify-between items-center">
      ...
      <View className="items-center justify-center bg-gray-50 dark:bg-slate-900 rounded-full w-20 h-20 border-4 border-gray-100 dark:border-slate-700">
